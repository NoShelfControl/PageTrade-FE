      ...
      <section className={styles.Careers}>
        ...
        <section id={styles.thiscontainer}>
          <figure>
            <h2>English Major</h2>
            <p>
              PageTrade is seeking an over-qualified, underpaid English major to
              join our team. <br />
              <br />
              Do you:
              <ul>
          ...
          <figure>
            <h2>Office Pets</h2>
            <p>
              PageTrade is seeking to incorporate more animals in our office
              setting. <br />
              <br />
              Qualifications:
              <ul>
          ...
          <figure>
            <h2>Junior Dev</h2>
            <p>
              PageTrade is seeking to fill a junior role on our team. <br />
              <br />
              Qualifications:
              <ul>
                <li>10 years of progressive experience</li>
                <li>
                  Robust portfolio demonstrating complex, algorithmic thinking
                </li>
